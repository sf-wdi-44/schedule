...
2. Finish the Twitter project, [Steps #8 ~ 11](https://docs.google.com/presentation/d/1_1387xNtElR2UTEljfuNXFRbWQVFg-AEy725kWHSQ9I/edit?usp=sharing). There is a `solution` branch on the original [Github repo](https://github.com/esthersweon/ga-twitter).
