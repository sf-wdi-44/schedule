...
2. Go through the "Installation" steps [here](https://github.com/SF-WDI-42/python) and type `python` into a terminal to make sure it opens a python REPL for you (similar to running `node` to get into the node REPL).
