...
3. Get started on the [Ruby method drills](https://github.com/SF-WDI-LABS/ruby-method-drills). Make sure to fork & clone, because you'll be submitting these later in the week.
